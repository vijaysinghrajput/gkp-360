...
const BusinessDetailsBreadcrumbList = ({
  currentCategory,
  title,
  listing_id,
  listing_slug,
        ...
        ? [
            {
              ...
              position: 4,
              name: `${title}`,
              item: `${domain}/${listing_slug}/${listing_id}/business-profile`,
            },
          ]
        : []),
    ],
...
BusinessDetailsBreadcrumbList.propTypes = {
...
export default BusinessDetailsBreadcrumbList;
