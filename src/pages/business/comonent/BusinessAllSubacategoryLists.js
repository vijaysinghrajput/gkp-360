...
const BusinessAllSubcategoryLists = ({ mainCategoryName, subcategories }) => {
  ...
  const seoTitle = `Explore Popular ${mainCategoryName} | ${
...
export default BusinessAllSubcategoryLists;
